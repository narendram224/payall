...
const SERVICES = [
  ...
  },
  {
    ...
    emoji: '🏦',
    title: 'Payout',
    desc: 'UPI & Bank Transfer',
    route: '/services/finance/payout',
  ...
  },
  {
    ...
    route: '/services/finance/car-loan',
  ...
  },
  {
    ...
    emoji: '🥇',
    title: 'Digital Gold',
    desc: 'Invest in 24K gold',
    route: '/services/finance/gold',
  ...
  },
  {
    ...
    desc: 'Invest in silver',
    route: '/services/finance/silver',
  ...
  },
  {
    ...
    emoji: '📱',
    title: 'Postpaid',
    desc: 'Mobile bill payment',
    route: '/services/finance/postpaid',
  ...
  },
  {
    ...
    emoji: '🔄',
    title: 'Auto Collect',
    desc: 'Virtual account collect',
    route: '/services/finance/auto-collect',
  ...
  },
  {
    ...
    route: '/services/finance/payment-gateway',
  ...
  },
  {
    ...
    emoji: '🎁',
    title: 'Gift Card',
    desc: 'Send gift vouchers',
    route: '/services/finance/gift-card',
    gradient: ['#f43f5e', '#f97316'] as [string, string],
  },
];
      ...
      <ScrollView
        ...
        <View className="flex-row flex-wrap gap-3">
          {SERVICES.map((s, i) => (
            <Animated.View
              key={s.id}
              entering={reducedMotion ? undefined : FadeInDown.delay(i * 50).duration(300)}
              style={{ width: '47%' }}>
              <Pressable
